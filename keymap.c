...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_LSHIFT,      KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           KC_PSCREEN,                                                                     KC_TRANSPARENT, KC_H,           KC_J,           KC_K,           KC_L,           KC_SCOLON,      KC_QUOTE,       
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_LSHIFT,      KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           LGUI(LSFT(KC_4)),                                                                KC_TRANSPARENT, KC_H,           KC_J,           KC_K,           KC_L,           KC_SCOLON,      KC_QUOTE,       
